...
public class ScabledLabelPanel  extends JPanel{
        private Image master;
        private boolean toFit;
        private Image scaled;

        public ScabledLabelPanel(Image master) {
            this(master, true);
            setDefaultSize();
        }

        public ScabledLabelPanel(Image master, boolean toFit) {
            this.master = master;
            setDefaultSize();
            setToFit(toFit);
        }
        ...
        public static void show(String title, BufferedImage img)
        {
             ...
             ScabledLabelPanel panel = new ScabledLabelPanel(img);
        ...
        {
        	try {
                BufferedImage image = ImageIO.read(new File("C:\\Users\\baolingfeng\\Desktop\\Collecter\\log\\screen\\2015-02-10-10-33-41-674.png"));

                JFrame frame = new JFrame("Test");
                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                frame.setLayout(new BorderLayout());
                
                ScabledLabelPanel panel = new ScabledLabelPanel(null);
