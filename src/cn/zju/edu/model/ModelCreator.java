...
public class ModelCreator {
    ...
    public static TimeBarModel createFlatModel() {
        ...
        DefaultRowHeader header = new DefaultRowHeader("Firefox");
        ...
        interval = new EventInterval(start.copy().advanceHours(10), start.copy().advanceHours(15));
        interval.setTitle("AcFun弹幕视频网 - 中国宅文化基地");
        row.addInterval(interval);
        ...
        // kat2
        row = new EventTimeBarRow(new DefaultRowHeader("Eclipse"));
        interval = new EventInterval(start.copy().advanceHours(11), start.copy().advanceHours(14));
        ...
        model.addRow(row);
        // kat3
        row = new EventTimeBarRow(new DefaultRowHeader("Chrome"));
        ...
        model.addRow(row);
        // kat4
        row = new EventTimeBarRow(new DefaultRowHeader("Document"));
