...
public class InteractionMonitor {
    ...
    {
    	InteractionMonitor example = new InteractionMonitor();
        example.run();
    }
    ...
    {
        JFrame f = new JFrame(InteractionMonitor.class.getName());
        f.setSize(1400, 600);
        ...
        dm.getInteractionData("baolingfeng");
        dm.aggrLLInteractions();
        TimeBarModel mymodel = dm.createFlatModel();
