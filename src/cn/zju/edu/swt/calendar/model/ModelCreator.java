package cn.zju.edu.swt.calendar.model;
...
public class ModelCreator {
    public static TimeBarModel createCalendarModel() {
        ...
        //model.createMonth(1, 2015);
        model.createMonth(2, 2015);
        model.createMonth(3, 2015);
        model.createMonth(4, 2015);
        model.createMonth(5, 2015);
